...
- The learner sees pending/saving/saved/error status, a Save now retry, and Save and Exit. Standalone launches explicitly show that LMS saving is unavailable.
