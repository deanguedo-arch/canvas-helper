...
- Exact-head run `31753504317` and PR-merge run `31753507312` passed the complete release gate.
- The independent audit blocker is closed. PR #1 may be made ready after the current documentation head retains green CI; merge remains a repository-owner action.
...
- Current docs-only PR head must pass the exact-head and PR-merge workflows before the PR is made ready.
