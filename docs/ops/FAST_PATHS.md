...
- A standalone workspace preview must preserve the Studio tab and expose a trusted return control only at the top level, never inside the embedded iframe preview.
