...
1. Added one-click launcher and ops docs:
  - `launch-canvas-helper.bat` (Windows)
  - `launch-canvas-helper.command` (macOS)
   - `docs/ops/*`
   - `README.md` links
...
1. Start Studio: `launch-canvas-helper.bat` (Windows) or `launch-canvas-helper.command` (macOS) -> option `1` (or run `npm run studio -- --host 127.0.0.1 --port 5173`).
