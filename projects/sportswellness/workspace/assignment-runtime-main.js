...
// --- PHASE 2A (VALUES) LOGIC ---
                        ...
                        <div class="grid gap-5 xl:grid-cols-[minmax(0,1.65fr)_minmax(340px,0.95fr)] xl:items-start">
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <p class="mt-2 p1-phase-subtitle text-xs uppercase tracking-[0.32em] text-slate-400">Phase 3 / spotlight control, cueing, and fortress routines</p>
                                </div>
                                <p class="max-w-4xl text-sm leading-7 text-slate-300 md:text-base">
                                    Concentration is a trained spotlight. This assignment turns the focus chapter into a repeatable system for
                                    naming distracters, selecting cues, anchoring attention, and resetting fast when pressure interrupts execution.
                                </p>
                            </div>
                            <div class="grid gap-3 sm:grid-cols-2 xl:grid-cols-1 xl:min-w-0">
                                <div class="rounded-2xl border border-cyan-400/20 bg-slate-900/80 p-4">
        ...
        function buildPhase3Step0Markup() {
            return `<div><p class="text-xs font-semibold uppercase tracking-[0.32em] text-cyan-300">Step 00</p><h2 class="mt-2 text-2xl font-black uppercase tracking-tight text-white">Mission briefing</h2><p class="mt-3 max-w-4xl text-sm leading-7 text-slate-300">Phase 3 treats concentration as a system, not a mood. Your job is to shrink the spotlight onto what matters, quiet Self 1, build cues that are simple enough to use fast, and create a fortress routine that survives mistakes, noise, and pressure.</p></div><div class="grid gap-4 lg:grid-cols-2 xl:grid-cols-4"><article class="rounded-2xl border border-cyan-400/20 bg-slate-900/80 p-5"><p class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">Spotlight control</p><p class="mt-3 text-sm leading-7 text-slate-300">Attention works best when it is narrow, external, and tied to execution rather than scoreboard noise, memory, or prediction.</p></article><article class="rounded-2xl border border-cyan-400/20 bg-slate-900/80 p-5"><p class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">Self 1 vs Self 2</p><p class="mt-3 text-sm leading-7 text-slate-300">The goal is not louder motivation. It is reducing judgment long enough for trained execution to take over.</p></article><article class="rounded-2xl border border-cyan-400/20 bg-slate-900/80 p-5"><p class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">Cue builder</p><p class="mt-3 text-sm leading-7 text-slate-300">Instructional cues guide behavior. Motivational cues add energy. Anchors keep the mind in the present tense.</p></article><article class="rounded-2xl border border-cyan-400/20 bg-slate-900/80 p-5"><p class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">Fortress routine</p><p class="mt-3 text-sm leading-7 text-slate-300">A routine is a transfer system from chaos to execution. It should be repeatable before performance and usable after disruption.</p></article></div><div class="flex justify-center pt-2"><button type="button" onclick="p3_showStep(1)" class="bg-sky-600 px-12 py-4 rounded-xl text-white font-black uppercase text-xs tracking-[0.2em] hover:bg-sky-500 transition-all shadow-lg shadow-sky-900/20 active:scale-95">Start Focus Build</button></div>`;
        }

        function buildPhase3Step1Markup() {
            return `<div><p class="text-xs font-semibold uppercase tracking-[0.32em] text-cyan-300">Step 01</p><h2 class="mt-2 text-2xl font-black uppercase tracking-tight text-white">Spotlight audit</h2><p class="mt-3 max-w-4xl text-sm leading-7 text-slate-300">Map the internal and external noise that pulls attention away from the task. Then define the narrow external target that deserves the spotlight instead.</p></div><div class="grid gap-5 lg:grid-cols-2"><label class="rounded-2xl border border-slate-700 bg-slate-900/75 p-5"><span class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">Internal distracters</span><p class="mt-2 text-sm leading-6 text-slate-400">What does Self 1 usually say when performance starts to wobble?</p><textarea id="p3_internal_dist" oninput="p3_saveData()" rows="5" class="mt-4 w-full rounded-2xl border border-cyan-400/25 bg-slate-950/80 px-4 py-3 text-sm text-white outline-none transition focus:border-cyan-300" placeholder="List the self-talk, tension, judgment, or emotional noise that usually steals your attention."></textarea></label><label class="rounded-2xl border border-slate-700 bg-slate-900/75 p-5"><span class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">Past / future traps</span><p class="mt-2 text-sm leading-6 text-slate-400">Where do you time travel when attention slips?</p><textarea id="p3_time_trap" oninput="p3_saveData()" rows="5" class="mt-4 w-full rounded-2xl border border-cyan-400/25 bg-slate-950/80 px-4 py-3 text-sm text-white outline-none transition focus:border-cyan-300" placeholder="Name the replay loops, fears, or future outcomes that usually hijack the present moment."></textarea></label><label class="rounded-2xl border border-slate-700 bg-slate-900/75 p-5"><span class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">External distracters</span><p class="mt-2 text-sm leading-6 text-slate-400">What in the environment tends to pull your spotlight off the task?</p><textarea id="p3_external_dist" oninput="p3_saveData()" rows="5" class="mt-4 w-full rounded-2xl border border-cyan-400/25 bg-slate-950/80 px-4 py-3 text-sm text-white outline-none transition focus:border-cyan-300" placeholder="Crowd, officiating, weather, opponents, spectators, teammates, or surroundings."></textarea></label><label class="rounded-2xl border border-slate-700 bg-slate-900/75 p-5"><span class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">Primary spotlight goal</span><p class="mt-2 text-sm leading-6 text-slate-400">What narrow external target deserves your attention in the heat of execution?</p><textarea id="p3_spotlight" oninput="p3_saveData()" rows="5" class="mt-4 w-full rounded-2xl border border-cyan-400/25 bg-slate-950/80 px-4 py-3 text-sm text-white outline-none transition focus:border-cyan-300" placeholder="State the controllable target your focus should lock onto when pressure rises."></textarea></label></div>`;
        }

        function buildPhase3Step2Markup() {
            return `<div><p class="text-xs font-semibold uppercase tracking-[0.32em] text-cyan-300">Step 02</p><h2 class="mt-2 text-2xl font-black uppercase tracking-tight text-white">Cue builder and anchors</h2><p class="mt-3 max-w-4xl text-sm leading-7 text-slate-300">Quiet Self 1 by choosing language and sensory anchors that are short, present, and immediately actionable. This step should feel executable, not inspirational.</p></div><div class="grid gap-5 xl:grid-cols-[1.15fr_0.85fr]"><div class="grid gap-5 lg:grid-cols-2"><label class="rounded-2xl border border-slate-700 bg-slate-900/75 p-5"><span class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">Instructional cue</span><p class="mt-2 text-sm leading-6 text-slate-400">What short phrase directs the behavior you want?</p><input id="p3_instructional_cue" oninput="p3_saveData()" class="mt-4 w-full rounded-2xl border border-cyan-400/25 bg-slate-950/80 px-4 py-3 text-sm text-white outline-none transition focus:border-cyan-300" placeholder="Example: tall, smooth, follow through, finish the line." /></label><label class="rounded-2xl border border-slate-700 bg-slate-900/75 p-5"><span class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">Motivational cue</span><p class="mt-2 text-sm leading-6 text-slate-400">What phrase injects effort or urgency without adding chaos?</p><input id="p3_motivational_cue" oninput="p3_saveData()" class="mt-4 w-full rounded-2xl border border-cyan-400/25 bg-slate-950/80 px-4 py-3 text-sm text-white outline-none transition focus:border-cyan-300" placeholder="Example: compete, attack, trust, drive, hunt." /></label><label class="rounded-2xl border border-slate-700 bg-slate-900/75 p-5"><span class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">Physical anchor</span><p class="mt-2 text-sm leading-6 text-slate-400">What sensory anchor brings the mind back to the now?</p><select id="p3_anchor_type" onchange="p3_saveData()" class="mt-4 w-full rounded-2xl border border-cyan-400/25 bg-slate-950/80 px-4 py-3 text-sm text-white outline-none transition focus:border-cyan-300"><option value="">Select anchor...</option><option value="Breath">Breath</option><option value="Object Detail">Object Detail</option><option value="Quiet Eye">Quiet Eye</option><option value="Sound">Sound</option></select></label><label class="rounded-2xl border border-slate-700 bg-slate-900/75 p-5"><span class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">Anchor usage</span><p class="mt-2 text-sm leading-6 text-slate-400">How will you use that anchor during a pause, reset, or restart?</p><textarea id="p3_anchor_usage" oninput="p3_saveData()" rows="5" class="mt-4 w-full rounded-2xl border border-cyan-400/25 bg-slate-950/80 px-4 py-3 text-sm text-white outline-none transition focus:border-cyan-300" placeholder="Describe the reset sequence that brings your attention back to the present."></textarea></label></div><div class="rounded-2xl border border-slate-700 bg-slate-900/75 p-5"><span class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">Why this matters</span><p class="mt-3 text-sm leading-7 text-slate-300">Good cues do not argue with the problem. They redirect behavior. Good anchors do not ask you to think harder. They give the body something present and repeatable to return to.</p><ul class="mt-4 space-y-2 text-sm leading-6 text-slate-300"><li>Instructional cues should guide an action, not a mood.</li><li>Motivational cues should add intent without making you frantic.</li><li>Anchors should be sensory and available quickly under stress.</li><li>Quiet Eye belongs in the cue system if stable visual fixation matters for execution.</li></ul></div></div>`;
        }

        function buildPhase3Step3Markup() {
            return `<div><p class="text-xs font-semibold uppercase tracking-[0.32em] text-cyan-300">Step 03</p><h2 class="mt-2 text-2xl font-black uppercase tracking-tight text-white">Fortress routine and what-if reset</h2><p class="mt-3 max-w-4xl text-sm leading-7 text-slate-300">Build the short sequence that transfers attention from noise to readiness. Then script the exact recovery plan you want when disruption hits.</p></div><div class="grid gap-5 xl:grid-cols-[1.15fr_0.85fr]"><div class="space-y-5"><div class="grid gap-5 lg:grid-cols-3"><label class="rounded-2xl border border-slate-700 bg-slate-900/75 p-5"><span class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">Routine step 1</span><p class="mt-2 text-sm leading-6 text-slate-400">What physical action starts the routine?</p><textarea id="p3_routine_1" oninput="p3_saveData()" rows="6" class="mt-4 w-full rounded-2xl border border-cyan-400/25 bg-slate-950/80 px-4 py-3 text-sm text-white outline-none transition focus:border-cyan-300" placeholder="Describe the physical action that starts focus on purpose."></textarea></label><label class="rounded-2xl border border-slate-700 bg-slate-900/75 p-5"><span class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">Routine step 2</span><p class="mt-2 text-sm leading-6 text-slate-400">What cue or image locks you into execution?</p><textarea id="p3_routine_2" oninput="p3_saveData()" rows="6" class="mt-4 w-full rounded-2xl border border-cyan-400/25 bg-slate-950/80 px-4 py-3 text-sm text-white outline-none transition focus:border-cyan-300" placeholder="Name the cue, image, or mental instruction that narrows your focus."></textarea></label><label class="rounded-2xl border border-slate-700 bg-slate-900/75 p-5"><span class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">Routine step 3</span><p class="mt-2 text-sm leading-6 text-slate-400">What final trigger releases you into execution?</p><textarea id="p3_routine_3" oninput="p3_saveData()" rows="6" class="mt-4 w-full rounded-2xl border border-cyan-400/25 bg-slate-950/80 px-4 py-3 text-sm text-white outline-none transition focus:border-cyan-300" placeholder="Use Quiet Eye, breath, posture, or another final trigger that says go."></textarea></label></div><div class="rounded-2xl border border-slate-700 bg-slate-900/75 p-5"><span class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">Fortress check</span><ul class="mt-3 space-y-2 text-sm leading-6 text-slate-300"><li>The routine should be short enough to repeat under pressure.</li><li>Each step should move attention closer to the task, not back to self-judgment.</li><li>The routine should help you enter execution and also re-enter after disruption.</li></ul></div></div><div class="space-y-5"><label class="rounded-2xl border border-slate-700 bg-slate-900/75 p-5"><span class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">High-pressure what-if</span><p class="mt-2 text-sm leading-6 text-slate-400">What predictable disruption tends to break your concentration?</p><textarea id="p3_what_if" oninput="p3_saveData()" rows="6" class="mt-4 w-full rounded-2xl border border-cyan-400/25 bg-slate-950/80 px-4 py-3 text-sm text-white outline-none transition focus:border-cyan-300" placeholder="Name the bad call, mistake, noise, opponent, or moment that usually cracks the system."></textarea></label><label class="rounded-2xl border border-slate-700 bg-slate-900/75 p-5"><span class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">Pre-planned reset</span><p class="mt-2 text-sm leading-6 text-slate-400">What is the tactical response that gets your spotlight back immediately?</p><textarea id="p3_response" oninput="p3_saveData()" rows="8" class="mt-4 w-full rounded-2xl border border-cyan-400/25 bg-slate-950/80 px-4 py-3 text-sm text-white outline-none transition focus:border-cyan-300" placeholder="Write the response you want to automate when disruption shows up."></textarea></label></div></div>`;
        }

        function buildPhase3Step4Markup() {
            return `<div><p class="text-xs font-semibold uppercase tracking-[0.32em] text-cyan-300">Step 04</p><h2 class="mt-2 text-2xl font-black uppercase tracking-tight text-white">Review and synthesis</h2><p class="mt-3 max-w-4xl text-sm leading-7 text-slate-300">Audit the focus system, then explain how the spotlight target, cues, anchor, and reset plan work together as one concentration routine.</p></div><div class="grid gap-5 xl:grid-cols-[1.15fr_0.85fr] p1-review-grid"><div class="space-y-5"><div class="rounded-2xl border border-slate-700 bg-slate-900/75 p-5"><span class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">Focus integrity audit</span><p class="mt-2 text-sm leading-6 text-slate-400">Score how specific, usable, and repeatable the concentration system feels right now.</p><div id="p3-scoring-container" class="mt-4 space-y-4"></div></div><div class="rounded-2xl border border-slate-700 bg-slate-900/75 p-5"><span class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">What strong focus work looks like</span><ul class="mt-3 space-y-2 text-sm leading-6 text-slate-300"><li>The spotlight target is narrow, external, and relevant to execution.</li><li>Cues are short, behavioral, and usable in the moment.</li><li>The anchor returns attention to the present rather than adding more thinking.</li><li>The fortress routine and reset plan are specific enough to survive disruption.</li></ul></div></div><div class="space-y-5"><label class="rounded-2xl border border-slate-700 bg-slate-900/75 p-5"><span class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">Understanding narrative</span><p class="mt-2 text-sm leading-6 text-slate-400">Explain how quieting Self 1, choosing cues, using an anchor, and building a fortress routine improve your concentration under pressure.</p><textarea id="p3_narrative" oninput="p3_saveData()" rows="11" class="mt-4 w-full rounded-2xl border border-cyan-400/25 bg-slate-950/80 px-4 py-3 text-sm text-white outline-none transition focus:border-cyan-300" placeholder="Show how the spotlight, cues, anchors, and reset logic connect into one believable concentration system."></textarea></label><div class="rounded-2xl border border-cyan-400/20 bg-slate-900/75 p-5"><span class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-300">Concentration summary</span><p id="p3-summary-preview" class="mt-3 text-sm leading-7 text-slate-300">...</p></div></div></div><div class="p1-rubric-shell overflow-x-auto"><table class="min-w-[980px] w-full border-collapse p1-rubric-table"><thead><tr><th>Criteria</th><th>Proficient</th><th>Developing</th><th>Emerging</th></tr></thead><tbody><tr><th>Spotlight audit</th><td>Internal noise, time traps, external distracters, and the spotlight target are specific and clearly task-relevant.</td><td>Some distracters are named, but the spotlight target stays broad, vague, or only partly actionable.</td><td>The audit is incomplete or does not define a usable spotlight target.</td></tr><tr><th>Cue builder</th><td>Instructional and motivational cues are short, behavioral, and clearly support performance.</td><td>Cues exist, but they are generic, too wordy, or not clearly tied to execution.</td><td>Cues are missing, confusing, or unusable in the moment.</td></tr><tr><th>Fortress plan</th><td>The routine and what-if reset create a repeatable path back to execution under pressure.</td><td>The routine exists, but parts are thin, inconsistent, or too vague to trust under disruption.</td><td>The fortress routine or reset plan is incomplete or missing.</td></tr><tr><th>Understanding narrative</th><td>The narrative shows strong understanding of spotlight control, Self 1 vs Self 2, cues, anchors, and reset logic.</td><td>The narrative covers some ideas but does not fully connect the concentration system.</td><td>The narrative is missing or shows limited understanding of how the system should work.</td></tr><tr><th>Integrity audit</th><td>Scoring and summary are honest, aligned with the work, and usable for future resets.</td><td>Scoring is present but only partly aligned with the actual blueprint.</td><td>Scoring is incomplete or not supported by the written plan.</td></tr></tbody></table></div><div class="flex flex-col md:flex-row gap-4 pt-2"><button type="button" onclick="p3_showStep(0)" class="flex-1 text-slate-500 font-bold uppercase text-[10px] tracking-widest hover:text-white transition-colors border border-slate-800 rounded-xl py-4"><- Start Over</button><button type="button" onclick="p3_generateFullPrint()" class="flex-[2] bg-emerald-600 hover:bg-emerald-500 text-white font-black uppercase tracking-widest py-4 rounded-xl shadow-lg transition-all active:scale-[0.98]">Generate Blueprint PDF</button></div>`;
        }
        ...
        function p3_getFormData() { return { internal_dist: phase2Value('p3_internal_dist'), time_trap: phase2Value('p3_time_trap'), external_dist: phase2Value('p3_external_dist'), spotlight: phase2Value('p3_spotlight'), instructional_cue: phase2Value('p3_instructional_cue'), motivational_cue: phase2Value('p3_motivational_cue'), anchor_type: phase2Value('p3_anchor_type'), anchor_usage: phase2Value('p3_anchor_usage'), routine_1: phase2Value('p3_routine_1'), routine_2: phase2Value('p3_routine_2'), routine_3: phase2Value('p3_routine_3'), what_if: phase2Value('p3_what_if'), response: phase2Value('p3_response'), narrative: phase2Value('p3_narrative'), scores: p3_scores }; }
