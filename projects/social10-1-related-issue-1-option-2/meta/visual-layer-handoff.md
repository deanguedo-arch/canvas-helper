...
## Summary
Applied the reviewed Social 30-1 Issue 1 Biology-style design and tools to social10-1-related-issue-1-option-2. Local Build candidate; not deployed, packaged or committed. Existing 10 lessons and completion requirements are unchanged.

## Files changed
- workspace/index.html: editable Overview, 10 lesson openings, sidebar, 24 sourced vocabulary entries, shared Frayer controls, 23 original textbook practice questions, media notes and collection controls.
...
projects/social10-1-related-issue-1-option-2/workspace/index.html

## Lesson 9 title refinement — 2026-09-18
Renamed inherited U1 title to Unit 1 Summary: Perspectives on Globalization across navigation, lesson heading, roadmap and supporting references. Original lesson-09 route, fields, completion requirement and teaching activities retained. Correction provenance recorded in lesson-support.json. Local affected-preview inspection; broader rollout gates remain deferred. Next file: workspace/index.html.
...
Production SCORM 2004 export and project E2E contract passed. Upload ZIP: `projects/social10-1-related-issue-1-option-2/exports/social10-1-related-issue-1-option-2-scorm-2004.zip`. Combined receipt: `projects/social30-1-related-issue-1-option-2/meta/option-two-scorm-release.json`. Outer download must be extracted; upload each inner ZIP individually. Final CRC, manifest, local-resource and analytics verification recorded in the receipt. Non-ASCII ZIP filename flags normalized after macOS packaging; verify again on subsequent exports. Actual Brightspace pilot and comprehensive Studio lifecycle remain deferred. Resource notes identify inherited missing materials; obtain teacher resources for dependent activities. No upload or deployment occurred.
