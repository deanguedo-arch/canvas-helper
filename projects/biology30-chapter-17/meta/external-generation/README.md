# Biology 30 — Chapter 17: Patterns and Processes in Inheritance
...
- `portable/Biology30_Chapter17.html`: derived single-file course; all core assets, fonts and the correct chapter PDF are embedded. Videos require internet, with local written equivalents.
...
14 teaching lessons plus the review; 15 required checks; 34 required selected-response items; 30 written explanations; 28 guided selections; 56 vocabulary terms; 6 labeling activities with 25 targets; 82 original textbook questions/selected supplied-data tasks; 22 reviewed source MC items plus 56 foundation and 14 authored application items. Additional families include flash retrieval, typed responses, ordering and multiple select where appropriate. One optional three-MC/one-written independent transfer set is present. Optional work does not increase required progress.
