...
function Badge({ children, className = "", ...props }) {
    return (_jsx("span", { ...props, className: `rounded-md border border-white/[0.12] bg-white/[0.03] px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.12em] text-[#a1a8b3] ${className}`.trim(), children: children }));
}
...
function HtmlRenderer({ html }) {
    ...
    return (_jsxs("div", { className: `${FORENSIC_THEME.panel} p-6`, "data-testid": "renderer-html", children: [_jsx("div", { className: "mb-4 flex flex-wrap justify-end gap-2", children: sections.length > 1 && (_jsxs(_Fragment, { children: [_jsx("button", { onClick: () => setSectionMode((prev) => !prev), className: FORENSIC_THEME.buttonSecondary, "data-testid": "section-mode-toggle", children: sectionMode ? "Single flow" : "Section mode" }), sectionMode && (_jsxs(_Fragment, { children: [_jsx("button", { onClick: expandAll, className: FORENSIC_THEME.buttonSecondary, "data-testid": "section-expand-all", children: "Expand all" }), _jsx("button", { onClick: collapseAll, className: FORENSIC_THEME.buttonSecondary, "data-testid": "section-collapse-all", children: "Collapse all" })] }))] })) }), sectionMode && sections.length > 1 ? (_jsx("div", { className: "space-y-3", children: sections.map((section) => {
                    const collapsed = !!collapsedSections[section.id];
                    return (_jsxs("div", { className: "rounded-xl border border-white/[0.1] bg-white/[0.02]", "data-testid": "section-container", children: [_jsxs("button", { onClick: () => setCollapsedSections((prev) => ({ ...prev, [section.id]: !prev[section.id] })), className: "flex w-full items-center justify-between px-4 py-3 text-left transition duration-200 hover:bg-white/[0.03]", children: [_jsx("span", { className: "text-sm font-semibold text-[#f3f4f6]", children: section.title }), _jsx("span", { className: FORENSIC_THEME.overline, children: collapsed ? "Expand" : "Collapse" })] }), !collapsed && (_jsx("div", { className: "max-w-none border-t border-white/[0.08] px-4 py-4 text-[#cbd5e1] [&_*]:!text-[#e5e7eb] [&_.image-banner]:my-4 [&_.image-banner]:rounded-xl [&_.image-banner]:border [&_.image-banner]:border-white/[0.1] [&_.image-banner]:bg-white/[0.04] [&_.image-banner]:p-8 [&_.image-banner]:text-center [&_h1]:mb-4 [&_h1]:text-3xl [&_h1]:font-semibold [&_h1]:tracking-tight [&_h1]:!text-[#f8fafc] [&_h2]:mb-3 [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:!text-[#f8fafc] [&_h3]:mb-2 [&_h3]:mt-5 [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:!text-[#f1f5f9] [&_ol]:list-decimal [&_ol]:pl-6 [&_p]:mb-4 [&_p]:leading-7 [&_p]:!text-[#e5e7eb] [&_li]:!text-[#e5e7eb] [&_strong]:!text-[#f8fafc] [&_em]:!text-[#e2e8f0] [&_table]:mt-4 [&_table]:w-full [&_table]:border-collapse [&_td]:border [&_td]:border-white/[0.12] [&_td]:p-3 [&_th]:border [&_th]:border-white/[0.14] [&_th]:bg-white/[0.06] [&_th]:p-3 [&_ul]:list-disc [&_ul]:pl-6", dangerouslySetInnerHTML: { __html: section.html } }))] }, section.id));
...
function QuizRenderer({ quiz, questions, meta, lessonId, quizDraft, onQuizDraftChange }) {
    ...
    const [questionIndex, setQuestionIndex] = useState(() => Number.isInteger(quizDraft?.questionIndex) ? quizDraft.questionIndex : 0);
    ...
    const [feedbackByQuestion, setFeedbackByQuestion] = useState(() => quizDraft?.feedbackByQuestion && typeof quizDraft.feedbackByQuestion === "object" ? quizDraft.feedbackByQuestion : {});
    ...
    useEffect(() => {
        ...
        setFeedbackByQuestion((prev) => Object.fromEntries(Object.entries(prev).filter(([questionId]) => validQuestionIds.has(questionId))));
    }, [questionSignature]);
    useEffect(() => {
    ...
    return (_jsxs("div", { className: `${FORENSIC_THEME.panel} p-6`, "data-testid": "renderer-quiz", children: [_jsxs("div", { className: "mb-5 flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("div", { className: FORENSIC_THEME.overline, children: "Assignments" }), _jsx("h4", { className: "mt-1 text-lg font-semibold text-[#f3f4f6]", children: "Module assessment" })] }), _jsxs("div", { className: "flex flex-wrap gap-2", children: [_jsxs(Badge, { children: [parsedQuestions.length, " questions"] }), _jsxs(Badge, { children: [correctCount, "/", parsedQuestions.length, " correct"] }), _jsxs(Badge, { "data-testid": "quiz-progress", children: [answeredCount, "/", parsedQuestions.length, " answered"] })] })] }), _jsx("div", { children: _jsxs("div", { children: [parsedQuestions.length > 1 && (_jsx("div", { className: "mb-4 flex flex-wrap gap-2", "data-testid": "quiz-question-nav", children: parsedQuestions.map((question, idx) => (_jsxs("button", { onClick: () => {
                                    setQuestionIndex(idx);
                                }, className: `rounded-lg border px-3 py-1.5 text-xs font-semibold transition duration-200 ${questionIndex === idx
                                    ? "border-[#b91c1c]/70 bg-[#1a1215] text-[#fecaca]"
                                    : "border-white/[0.12] bg-white/[0.02] text-[#a1a8b3] hover:border-white/[0.24] hover:text-[#f3f4f6]"}`, "data-testid": "quiz-question-button", "data-current": questionIndex === idx ? "true" : "false", children: ["Q", idx + 1, " ", answersByQuestion[question.id] !== undefined ? "•" : ""] }, question.id))) })), _jsx("div", { className: "mb-4 h-2 overflow-hidden rounded-full bg-white/[0.08]", children: _jsx("div", { className: "h-full rounded-full bg-[#b91c1c]", style: { width: `${parsedQuestions.length ? (answeredCount / parsedQuestions.length) * 100 : 0}%` } }) }), _jsx("p", { className: "text-sm leading-7 text-[#d1d5db]", children: activeQuestion?.question || "No quiz question parsed." }), _jsx("div", { className: "mt-5 space-y-3", children: activeQuestion?.choices?.map((choice, idx) => (_jsx("button", { onClick: () => {
                                    setAnswersByQuestion((prev) => ({ ...prev, [activeQuestionId]: idx }));
                                    setFeedbackByQuestion((prev) => ({ ...prev, [activeQuestionId]: false }));
                                }, className: `w-full rounded-2xl border p-4 text-left text-sm transition ${currentSelected === idx
                                    ? "border-[#b91c1c]/70 bg-[#1a1215] text-[#f3f4f6]"
                                    : "border-white/[0.12] bg-white/[0.02] text-[#cbd5e1] hover:border-white/[0.24] hover:bg-white/[0.05]"}`, "data-testid": "quiz-answer-choice", children: choice }, idx))) }), _jsxs("div", { className: "mt-5 flex flex-wrap gap-3", children: [_jsx("button", { onClick: () => setFeedbackByQuestion((prev) => ({ ...prev, [activeQuestionId]: true })), className: `w-full sm:w-auto ${FORENSIC_THEME.buttonPrimary}`, "data-testid": "quiz-check-answer", children: "Check answer" }), _jsx("button", { onClick: () => {
                                        setAnswersByQuestion((prev) => ({ ...prev, [activeQuestionId]: undefined }));
                                        setFeedbackByQuestion((prev) => ({ ...prev, [activeQuestionId]: false }));
                                    }, className: `w-full sm:w-auto ${FORENSIC_THEME.buttonSecondary}`, children: "Clear answer" }), _jsx("button", { onClick: resetQuizAttempt, className: `w-full sm:w-auto ${FORENSIC_THEME.buttonSecondary}`, children: "Retake quiz" }), _jsx("button", { onClick: generateQuizReport, className: `w-full sm:w-auto ${FORENSIC_THEME.buttonSecondary}`, children: "Generate report" }), parsedQuestions.length > 1 && (_jsx("button", { onClick: () => {
                                        if (questionIndex < parsedQuestions.length - 1) {
                                            setQuestionIndex((idx) => idx + 1);
                                        }
                                    }, className: `w-full sm:w-auto ${FORENSIC_THEME.buttonSecondary}`, "data-testid": "quiz-next-question", children: "Next question" }))] }), showFeedback && currentSelected !== undefined && (_jsxs("div", { className: `mt-5 rounded-2xl border p-4 ${correct ? "border-emerald-400/35 bg-emerald-950/30" : "border-[#dc2626]/45 bg-[#2d0f14]"}`, children: [_jsx("div", { className: `text-sm font-semibold ${correct ? "text-emerald-300" : "text-rose-300"}`, children: correct ? "Correct" : "Wrong" }), _jsxs("p", { className: `mt-2 text-sm leading-7 ${correct ? "text-emerald-100" : "text-rose-100"}`, children: ["In the exported quiz, the correct answer is ", _jsx("strong", { children: activeQuestion?.choices?.[activeQuestion?.answerIndex] }), "."] })] }))] }) })] }));
}
...
function renderNodePreview(activeLesson, sourcePreview, persistedState) {
    ...
    if (activeLesson.type === "quiz") {
        ...
        return (_jsx(QuizRenderer, { quiz: quiz, questions: questions, meta: meta, lessonId: activeLesson.id, quizDraft: persistedState?.quizDrafts?.[activeLesson.id], onQuizDraftChange: persistedState?.onQuizDraftChange }));
    }
...
export default function ForensicCoursePlayerPreviewRestored() {
    ...
    const [activeModuleView, setActiveModuleView] = useState(initialUiState.activeModuleView === "assignments" ? "assignments" : "content");
    ...
    useEffect(() => {
        if (activeModuleView !== "assignments")
            return;
    ...
    if (!activeChapter) {
        return (_jsx("div", { className: "forensic-app min-h-screen bg-[#0a0b0d] p-4 text-[#a1a8b3] sm:p-8", children: "No chapters were mapped from the D2L course map yet." }));
    }
    return (_jsxs("div", { className: "forensic-app min-h-screen bg-[radial-gradient(circle_at_18%_-10%,rgba(185,28,28,0.2),transparent_36%),radial-gradient(circle_at_84%_0%,rgba(148,163,184,0.12),transparent_34%),#0a0b0d] text-[#f3f4f6]", children: [_jsx("style", { children: `
        .forensic-app {
      ...
      ` }), _jsxs("div", { className: "flex min-h-screen", children: [_jsx("button", { type: "button", className: `fixed inset-0 z-30 bg-black/65 transition-opacity duration-200 lg:hidden ${isMobileMenuOpen ? "opacity-100" : "pointer-events-none opacity-0"}`, "aria-hidden": isMobileMenuOpen ? "false" : "true", onClick: () => setIsMobileMenuOpen(false), title: "Close menu overlay" }), _jsxs("aside", { className: `fixed inset-y-0 left-0 z-40 h-screen shrink-0 overflow-hidden border-r border-white/[0.08] bg-[#101216]/95 backdrop-blur-xl transition-[width,transform] duration-200 lg:sticky lg:top-0 lg:z-0 lg:bg-[#101216]/90 ${isMobileMenuOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"} ${isMenuCollapsed ? "lg:w-16" : "w-[86vw] max-w-[340px] lg:w-[340px]"}
          }`, "data-testid": "chapter-menu-panel", "data-collapsed": isMenuCollapsed ? "true" : "false", children: [_jsxs("div", { className: `border-b border-white/[0.08] ${isMenuCollapsed ? "px-2 py-4" : "px-5 py-5"}`, children: [_jsxs("div", { className: `mb-3 flex ${isMenuCollapsed ? "justify-center" : "items-start justify-between gap-3"}`, children: [!isMenuCollapsed ? (_jsxs("div", { children: [_jsx("div", { className: FORENSIC_THEME.overline, children: "Case file" }), _jsx("h1", { className: "mt-1 text-xl font-semibold text-[#f3f4f6]", children: resolvedCourse.title })] })) : null, _jsx("button", { type: "button", onClick: () => setIsMobileMenuOpen(false), className: "flex h-10 w-10 items-center justify-center rounded-lg border border-white/[0.14] bg-white/[0.04] text-[#d1d5db] transition duration-200 hover:border-white/[0.28] hover:bg-white/[0.08] hover:text-[#f3f4f6] lg:hidden", "aria-label": "Close chapter menu", title: "Close chapter menu", children: _jsx("span", { className: "text-lg leading-none", children: "\u00D7" }) }), _jsx("button", { type: "button", onClick: () => setIsChapterMenuCollapsed((prev) => !prev), className: `hidden h-10 w-10 items-center justify-center rounded-lg border transition duration-200 lg:flex ${isMenuCollapsed
                                                    ? "border-[#dc2626]/70 bg-[#b91c1c] text-[#fef2f2] hover:bg-[#dc2626] hover:shadow-[0_0_0_1px_rgba(220,38,38,0.45)]"
                                                    : "border-white/[0.14] bg-white/[0.04] text-[#d1d5db] hover:border-white/[0.28] hover:bg-white/[0.08] hover:text-[#f3f4f6]"}`, "data-testid": "chapter-menu-toggle", "aria-expanded": isMenuCollapsed ? "false" : "true", "aria-label": isMenuCollapsed ? "Open chapter menu" : "Collapse chapter menu", title: isMenuCollapsed ? "Open chapter menu" : "Collapse chapter menu", children: _jsxs("span", { className: "flex flex-col gap-1.5", children: [_jsx("span", { className: `block h-[2px] w-4 rounded-full ${isMenuCollapsed ? "bg-[#fef2f2]" : "bg-[#d1d5db]"}` }), _jsx("span", { className: `block h-[2px] w-4 rounded-full ${isMenuCollapsed ? "bg-[#fef2f2]" : "bg-[#d1d5db]"}` }), _jsx("span", { className: `block h-[2px] w-4 rounded-full ${isMenuCollapsed ? "bg-[#fef2f2]" : "bg-[#d1d5db]"}` })] }) })] }), isMenuCollapsed ? null : (_jsxs(_Fragment, { children: [_jsxs("div", { className: `${FORENSIC_THEME.panelSoft} p-3`, children: [_jsxs("div", { className: "mb-2 flex items-center justify-between text-sm", children: [_jsx("span", { className: "font-medium text-[#a1a8b3]", children: "Progress" }), _jsxs("span", { className: "font-semibold text-[#f3f4f6]", children: [progress, "%"] })] }), _jsx("div", { className: "h-2 overflow-hidden rounded-full bg-white/[0.08]", children: _jsx("div", { className: "h-full rounded-full bg-[#b91c1c]", style: { width: `${progress}%` } }) }), _jsxs("div", { className: "mt-3 grid grid-cols-2 gap-2 text-xs text-[#6b7280]", children: [_jsxs("div", { className: "rounded-lg border border-white/[0.08] bg-white/[0.03] p-2", children: [resolvedCourse.stats.topLevelSections, " sections"] }), _jsxs("div", { className: "rounded-lg border border-white/[0.08] bg-white/[0.03] p-2", children: [resolvedCourse.stats.totalNodes, " nodes"] })] })] }), _jsxs("div", { className: "relative mt-4", children: [_jsx(Search, { className: "pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[#6b7280]" }), _jsx("input", { value: query, onChange: (e) => setQuery(e.target.value), placeholder: "Search chapter titles", className: "w-full rounded-lg border border-white/[0.12] bg-white/[0.03] py-2.5 pl-9 pr-3 text-sm text-[#e5e7eb] outline-none placeholder:text-[#6b7280] focus:border-[#b91c1c]/70", "data-testid": "lesson-search" })] })] }))] }), _jsx("div", { className: `${isMenuCollapsed ? "hidden" : "h-[calc(100vh-245px)] overflow-y-auto px-3 py-4"}`, "data-testid": "module-list", children: safeModules.map((module) => {
                                    const isActive = module.id === activeChapter.id;
                                    return (_jsxs("div", { className: "mb-3 rounded-xl border border-white/[0.1] bg-[#141821] p-2 shadow-[0_14px_30px_rgba(0,0,0,0.35)]", "data-testid": "module-panel", "data-module-title": module.title, "data-module-hidden": module.isHidden ? "true" : "false", "data-module-expanded": isActive ? "true" : "false", children: [_jsxs("button", { onClick: () => {
                                                    setActiveChapterId(module.id);
                                                    setActiveModuleView("content");
                                                }, className: "flex w-full items-center justify-between rounded-lg px-2 py-2 text-left transition duration-200 hover:bg-white/[0.04]", "data-testid": "module-toggle", "data-module-title": module.title, "data-expanded": isActive ? "true" : "false", children: [_jsxs("div", { children: [_jsx("div", { className: "text-sm font-semibold text-[#f3f4f6]", children: formatModuleTitleForDisplay(module.title) }), _jsxs("div", { className: "text-xs text-[#6b7280]", children: [module.lessonCount, " items in export"] })] }), module.isHidden && _jsx(Badge, { children: "hidden module" }), isActive ? _jsx(ChevronDown, { className: "h-4 w-4 text-[#a1a8b3]" }) : _jsx(ChevronRight, { className: "h-4 w-4 text-[#6b7280]" })] }), isActive && module.lessons?.some((lesson) => lesson.type === "quiz" || lesson.type === "assignment") ? (_jsx("div", { className: "mt-1 rounded-lg border border-white/[0.08] bg-white/[0.03] p-1", "data-testid": "module-submenu", children: _jsxs("button", { onClick: (event) => {
                                                        event.stopPropagation();
                                                        setActiveChapterId(module.id);
                                                        setActiveModuleView("assignments");
                                                    }, className: `flex w-full items-center justify-between rounded-md px-2 py-1.5 text-left text-xs font-semibold uppercase tracking-[0.12em] transition ${activeModuleView === "assignments"
                                                        ? "bg-[#1f1014] text-[#fecaca] ring-1 ring-[#dc2626]/45"
                                                        : "text-[#a1a8b3] hover:bg-white/[0.06] hover:text-[#f3f4f6]"}`, "data-testid": "module-assignments-tab", "data-module-title": module.title, children: [_jsx("span", { children: "Assignments" }), _jsx("span", { className: "text-[10px] text-[#6b7280]", children: module.lessons.filter((lesson) => lesson.type === "quiz" || lesson.type === "assignment").length })] }) })) : null] }, module.id));
                                }) })] }), _jsxs("main", { className: "min-w-0 flex-1 overflow-x-hidden overflow-y-auto", children: [_jsx("div", { className: "sticky top-0 z-10 border-b border-white/[0.08] bg-[#101216]/95 shadow-[0_10px_24px_rgba(0,0,0,0.45)] backdrop-blur-xl", children: _jsxs("div", { className: "px-4 py-4 sm:px-6 lg:px-8 lg:py-5", children: [_jsxs("div", { className: "mb-2 flex flex-wrap items-center gap-2 text-sm text-[#a1a8b3]", children: [_jsx("button", { type: "button", onClick: () => setIsMobileMenuOpen(true), className: "flex h-9 w-9 items-center justify-center rounded-lg border border-white/[0.14] bg-white/[0.04] text-[#d1d5db] transition duration-200 hover:border-white/[0.28] hover:bg-white/[0.08] hover:text-[#f3f4f6] lg:hidden", "aria-label": "Open chapter menu", title: "Open chapter menu", children: _jsxs("span", { className: "flex flex-col gap-1.5", children: [_jsx("span", { className: "block h-[2px] w-4 rounded-full bg-[#d1d5db]" }), _jsx("span", { className: "block h-[2px] w-4 rounded-full bg-[#d1d5db]" }), _jsx("span", { className: "block h-[2px] w-4 rounded-full bg-[#d1d5db]" })] }) }), _jsx("span", { className: "text-[#f3f4f6]", children: formatModuleTitleForDisplay(activeChapter.title) })] }), _jsx("h2", { className: "text-3xl font-semibold tracking-tight text-[#f3f4f6]", "data-testid": "lesson-title", children: formatModuleTitleForDisplay(activeChapter.title) }), _jsx("div", { className: "mt-3", children: _jsx(Badge, { children: activeModuleView === "assignments" ? "assignments view" : "content view" }) })] }) }), _jsx("div", { className: "mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 lg:py-10", children: activeModuleView === "assignments" ? (_jsxs("div", { className: "space-y-6", "data-testid": "module-assignments-view", children: [_jsxs("section", { className: `${FORENSIC_THEME.panel} p-8`, children: [_jsxs("div", { className: "mb-5 flex items-center justify-between", children: [_jsx("h3", { className: "text-xl font-semibold text-[#f3f4f6]", children: "Assignments" }), _jsxs(Badge, { children: [chapterAssignments.length, " assessments"] })] }), _jsxs("p", { className: "text-sm text-[#a1a8b3]", children: ["Assessment items for ", formatModuleTitleForDisplay(activeChapter.title), " are grouped in this dedicated view."] })] }), chapterAssignments.length === 0 ? (_jsxs("section", { className: `${FORENSIC_THEME.panel} p-8`, children: [_jsx("h3", { className: "text-xl font-semibold text-[#f3f4f6]", children: "No assignments in this module" }), _jsx("p", { className: "mt-3 text-sm text-[#a1a8b3]", children: "Return to the module content view or choose another module with assessment items." })] })) : (chapterAssignments.map((lesson) => (_jsx(ChapterLessonCard, { lesson: lesson, quizDrafts: quizDrafts, onQuizDraftChange: handleQuizDraftChange, labDrafts: labDrafts, onLabDraftChange: handleLabDraftChange }, lesson.id))))] })) : (_jsxs("div", { className: "space-y-6", "data-testid": "module-content-view", children: [chapterLessons.length === 0 ? (_jsxs("section", { className: `${FORENSIC_THEME.panel} p-8`, children: [_jsx("h3", { className: "text-xl font-semibold text-[#f3f4f6]", children: "No learner content in this module" }), _jsx("p", { className: "mt-3 text-sm text-[#a1a8b3]", children: "This module currently contains only assessment items. Use the Assignments tab under the module name." })] })) : null, chapterLessons.map((lesson) => (_jsx(ChapterLessonCard, { lesson: lesson, quizDrafts: quizDrafts, onQuizDraftChange: handleQuizDraftChange, labDrafts: labDrafts, onLabDraftChange: handleLabDraftChange }, lesson.id)))] })) })] })] })] }));
}
