...
## Summary
Applied the reviewed Social 30-1 Issue 1 Biology-style design and tools to social20-1-related-issue-1-option-2. Local Build candidate; not deployed, packaged or committed. Existing 23 lessons and completion requirements are unchanged.

## Files changed
- workspace/index.html: editable Overview, 23 lesson openings, sidebar, 68 sourced vocabulary entries, shared Frayer controls, 10 original textbook practice questions, media notes and collection controls.
...
projects/social20-1-related-issue-1-option-2/workspace/index.html

## Lesson image refinement — 2026-09-18
Scoped image pass on 28 imported lesson images: retain authored widths, preserve intrinsic proportions, constrain to reader width, add space beside floated illustrations, put large figures in their own row, and stack illustrations on phones. Original image sources, teaching text and learner IDs retained. Build preview inspection only; broader rollout checks remain deferred.
Verification: local rendered image pass at 1440px and 390px confirmed all lesson images load and remain within the reader; desktop/phone screenshots of lesson 15 in Issue 1 inspected. Existing image borders explain outer-box ratio rounding; intrinsic height remains automatic. No saved-work behavior changed.

Follow-up: curated small teaching photographs, portraits, cartoons and source illustrations now use a consistent 220px width rather than imported thumbnail widths; phones remain bounded by the reader. Original low-resolution assets retained. Selection recorded in lesson-image-presentation.json. Flags, logos, symbols and decorative icons excluded.
...
Production SCORM 2004 export and project E2E contract passed. Upload ZIP: `projects/social20-1-related-issue-1-option-2/exports/social20-1-related-issue-1-option-2-scorm-2004.zip`. Combined receipt: `projects/social30-1-related-issue-1-option-2/meta/option-two-scorm-release.json`. Outer download must be extracted; upload each inner ZIP individually. Final CRC, manifest, local-resource and analytics verification recorded in the receipt. Non-ASCII ZIP filename flags normalized after macOS packaging; verify again on subsequent exports. Actual Brightspace pilot and comprehensive Studio lifecycle remain deferred. Resource notes identify inherited missing materials; obtain teacher resources for dependent activities. No upload or deployment occurred.
...
### Single-course v3 — verified timestamp rejection
Read-only live console inspection found Brightspace error 406 rejecting the three-decimal ISO timestamp at cmi.interactions.0.timestamp. Native timestamp now uses whole-second UTC precision. Focused Social 20 Issue 1 save/reopen test with strict timestamp rejection passed. Only this issue re-exported and ZIP integrity/manifest/current bridge verified. Direct v3 ZIP and receipt recorded in meta/scorm-troubleshooting-release.json. Live acceptance of the correction still pending; no LMS upload performed. Save now keeps the attempt open; Save and Exit terminates it and requires reopening through Brightspace.


### Single-course v4 — automatic saving
Teacher requested silent automatic saving. Canonical body now opts into data-scorm-save-mode="automatic"; no Save and Exit control or successful-save banner, with required-save failure retry still visible. Debounced saves, heartbeat, navigation/visibility persistence and unload termination remain. Focused automatic save/reopen and failed-commit/retry checks plus 26 shared unit checks passed. Use v4 in scorm-troubleshooting-release.json; intermediate v3 superseded. Actual Brightspace correction/reporting acceptance remains pending. Sibling opt-ins/packages unchanged.
