...
PROJECT_SLUG = "mental-health-wellness"
DATA_GLOBAL = "MENTAL_HEALTH_WELLNESS_DATA"
SOURCE_REF_ROOT = "mental-health-wellness"
CONFIG = COURSES["mental-health-wellness"]
...
class MentalHealthWellnessShellBuilder:
    ...
    def prepare(self) -> None:
        ...
        styles = styles.replace("Forensics 25", "Mental Health & Wellness")
...
"""
    ...
    def collect_chapters(self) -> list[dict[str, Any]]:
        ...
        for item in top_modules(self.manifest_root):
            ...
            if normalize_key(title) == "course information":
                skip_reason = "content-shell-excluded-course-information"
            if skip_reason:
...
<head>
  ...
  <title>{escape(chapter["title"])} | Mental Health &amp; Wellness</title>
...
"""
  ...
  const readyType = "mental-health-wellness-module-progress-ready";
...
<head>
<meta charset="utf-8">
<title>Mental Health &amp; Wellness Brightspace Import Baseline</title>
</head>
<body>
<h1>Mental Health &amp; Wellness Brightspace Import Baseline</h1>
