...
## Summary
Applied the reviewed Social 30-1 Issue 1 Biology-style design and tools to social20-1-related-issue-4-option-2. Local Build candidate; not deployed, packaged or committed. Existing 21 lessons and completion requirements are unchanged.

## Files changed
- workspace/index.html: editable Overview, 21 lesson openings, sidebar, 30 sourced vocabulary entries, shared Frayer controls, 13 original textbook practice questions, media notes and collection controls.
...
Scoped image pass on 66 imported lesson images: retain authored widths, preserve intrinsic proportions, constrain to reader width, add space beside floated illustrations, put large figures in their own row, and stack illustrations on phones. Original image sources, teaching text and learner IDs retained. Build preview inspection only; broader rollout checks remain deferred.
...
Production SCORM 2004 export and project E2E contract passed. Upload ZIP: `projects/social20-1-related-issue-4-option-2/exports/social20-1-related-issue-4-option-2-scorm-2004.zip`. Combined receipt: `projects/social30-1-related-issue-1-option-2/meta/option-two-scorm-release.json`. Outer download must be extracted; upload each inner ZIP individually. Final CRC, manifest, local-resource and analytics verification recorded in the receipt. Non-ASCII ZIP filename flags normalized after macOS packaging; verify again on subsequent exports. Actual Brightspace pilot and comprehensive Studio lifecycle remain deferred. Resource notes identify inherited missing materials; obtain teacher resources for dependent activities. No upload or deployment occurred.
