...
## Current complete-build review — 2026-09-06

Start at the [canonical playbook, current recipe and entry 36](../../biology30-unit-a-pilot/meta/unit-a-to-bcd-improvement-playbook.md), then the [single final clearance checklist](./final-clearance-review.md). Current learner SHA: `ab82b791d0bc771a522c6bd2d88c97a2f28e5ecaa0add9d69cb32a1be580c105`. The older gate-focus sections below describe preserved candidates; they are not new slice-pause instructions.

The final candidate supports fully online delivery: fourteen three-panel local media paths, caption-reviewed focused videos, five saved identification matrices, real tissue observation and three supplied-data investigations. Current technical results are in [final verification](./final-academic-verification.json). Complete teacher review remains pending, including the explicit Final Practice 6/3/7/2 weighting variance. No changes to required questions/keys, 18-route completion, 1,505/295 times, old responses or protected Pilot 1/A–D learner files. Schema 6; maximum ordinary-length fixture 42,738 characters.

Do not treat online participation as proof of physical laboratory performance, actual collaboration or academic mastery. Do not deploy, export, promote, enable Studio Edit or transfer to B–D without the distinct required authority.
