(function () {
  const STORAGE_KEY = "worldreligions30-option1.assignment.chapter9interactive";
  const HEIGHT_MESSAGE = "wr30-assignment-height";
  const FRAME_KEY = "chapter9interactive";
  const STEPS = [
    {
      id: "identification",
      title: "Artifact Identification",
      marks: 2,
      copy: "Identify the symbol, article of faith, or practice you selected before you begin the explanation."
    },
    {
      id: "description",
    ...
    {
      id: "values",
      title: "Sikh Beliefs and Values",
      marks: 4,
      copy: "Explain what Sikh beliefs or values it communicates."
    },
    {
      id: "misunderstanding",
      title: "Clarifying Misconceptions",
      marks: 3,
      copy: "Describe one misunderstanding people may have about it and explain how you would correct that misunderstanding."
    },
    {
      id: "bibliography",
      title: "Bibliography",
  ...
  function getReportData() {
    const f = state.fields;
    const checklist = [
      { label: "Selected symbol or practice recorded", complete: Boolean(f.itemName) },
      { label: "Detailed description recorded", complete: Boolean(f.description) },
      { label: "Sikh beliefs or values explained", complete: Boolean(f.values) },
      { label: "Misunderstanding correction explained", complete: Boolean(f.misunderstanding) },
    ...
    return {
      ready,
      title: f.itemName || "Unnamed Sikh symbol or practice",
      subtitle: f.itemName ? `Sikh symbol or practice study: ${f.itemName}` : "Select a Sikh symbol, article of faith, or practice to build the report.",
      intro: "A Chapter 9 study report built from the notes below. Review the wording, then generate the printable version from this page.",
      meta: [
        { label: "Selected topic", value: f.itemName || "Not yet recorded" },
        { label: "Misunderstanding correction", value: f.misunderstanding ? "Correction drafted" : "Not yet recorded" },
      ...
      sections: [
        ...
        {
          label: "Sikh beliefs and values",
          value: f.values || "No Sikh beliefs and values section recorded yet."
        },
        {
          label: "Clarifying misconceptions",
          value: f.misunderstanding || "No misconception correction recorded yet."
        },
        {
          label: "Bibliography",
          list: [
  ...
  function renderHeader() {
    ...
    refs.stepCode.textContent = `Chapter 9 · Step ${state.activeStep + 1}`;
  ...
  function renderIdentification() {
    return `
      <div class="step-section">
        ${renderField("Symbol, article of faith, or practice", "itemName", "Example: The Five Ks, Langar, Khanda, Kara, Seva")}
      </div>
    `;
  }
    ...
    return `
      <div class="step-section">
        ${renderTextArea(
          ...
          "You can include history, meaning, daily use, visual features, ritual role, or community setting."
        )}
      </div>
    `;
  }
    ...
    return `
      <div class="step-section">
        ${renderTextArea(
          ...
          "values",
          "Explain what Sikh beliefs or values it communicates.",
          "You can discuss equality, devotion, discipline, courage, seva, remembrance of God, or community."
        )}
      </div>
    `;
  }
    ...
    return `
      <div class="step-section">
        ${renderTextArea(
          ...
          "misunderstanding",
          "Describe one misunderstanding people may have about it and explain how you would correct that misunderstanding.",
          "Explain the misunderstanding clearly, then replace it with an accurate and respectful explanation."
        )}
      </div>
    `;
  }
...
<body>
  <div class="report-page">
    ...
    <header class="report-head">
      <div>
        <p class="report-code">Chapter 9 Report</p>
