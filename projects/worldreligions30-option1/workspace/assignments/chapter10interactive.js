(function () {
  const STORAGE_KEY = "worldreligions30-option1.assignment.chapter10interactive";
  const HEIGHT_MESSAGE = "wr30-assignment-height";
  const FRAME_KEY = "chapter10interactive";
  const STEPS = [
    {
      id: "identification",
      title: "Example Identification",
      marks: 2,
      copy: "Identify the Canadian interfaith or multi-faith example you selected before you begin the explanation."
    },
    {
      id: "description",
    ...
    {
      id: "benefits",
      title: "Benefits of Pluralism",
      marks: 4,
      copy: "Explain which benefits of pluralism or dialogue are visible in your example."
    },
    {
      id: "challenge",
      title: "Ongoing Challenge",
      marks: 3,
      copy: "Describe one challenge the example may still face."
    },
    {
      id: "bibliography",
      title: "Bibliography",
  ...
  function getCompletedStepCount() {
    ...
    return [
      ...
      Boolean(f.itemName && f.description && f.benefits && f.challenge)
  ...
  function getReportData() {
    const f = state.fields;
    const checklist = [
      { label: "Selected Canadian example recorded", complete: Boolean(f.itemName) },
      { label: "Detailed description recorded", complete: Boolean(f.description) },
      { label: "Benefits of pluralism or dialogue explained", complete: Boolean(f.benefits) },
      { label: "Ongoing challenge explained", complete: Boolean(f.challenge) },
    ...
    return {
      ready,
      title: f.itemName || "Unnamed Canadian interfaith example",
      subtitle: f.itemName ? `Canadian interfaith example study: ${f.itemName}` : "Select a Canadian interfaith or multi-faith example to build the report.",
      intro: "A Chapter 10 study report built from the notes below. Review the wording, then generate the printable version from this page.",
      meta: [
        { label: "Selected example", value: f.itemName || "Not yet recorded" },
        { label: "Pluralism benefits", value: f.benefits ? "Benefits section drafted" : "Not yet recorded" },
        { label: "Ongoing challenge", value: f.challenge ? "Challenge section drafted" : "Not yet recorded" },
      ...
      sections: [
        ...
        {
          label: "Benefits of pluralism or dialogue",
          value: f.benefits || "No pluralism or dialogue benefits section recorded yet."
        },
        {
          label: "Ongoing challenge",
          value: f.challenge || "No ongoing challenge recorded yet."
        },
        {
          label: "Bibliography",
          list: [
  ...
  function renderHeader() {
    ...
    refs.stepCode.textContent = `Chapter 10 · Step ${state.activeStep + 1}`;
  ...
  function renderIdentification() {
    return `
      <div class="step-section">
        ${renderField("Canadian example", "itemName", "Example: An interfaith food bank, a multi-faith prayer service, a local dialogue circle, or an interfaith festival")}
      </div>
    `;
  }
    ...
    return `
      <div class="step-section">
        ${renderTextArea(
          ...
          "You can include where it happens, who is involved, what activities take place, how often it occurs, and what role it plays in the community."
        )}
      </div>
    `;
  }
  ...
  function renderBenefits() {
    return `
      <div class="step-section">
        ${renderTextArea(
          "Benefits of pluralism or dialogue",
          "benefits",
          "Explain which benefits of pluralism or dialogue are visible in your example.",
          "You can discuss understanding, reduced prejudice, cooperation, civic trust, respectful exchange, or community problem-solving."
        )}
      </div>
    `;
  }
    ...
    return `
      <div class="step-section">
        ${renderTextArea(
          ...
          "You can address misunderstanding, public resistance, funding pressure, unequal participation, or the difficulty of sustaining long-term dialogue."
        )}
      </div>
    `;
  }
...
<body>
  <div class="report-page">
    ...
    <header class="report-head">
      <div>
        <p class="report-code">Chapter 10 Report</p>
  ...
  function renderPanel() {
    switch (STEPS[state.activeStep].id) {
      ...
      case "description":
        ...
        return;
      case "benefits":
        refs.panel.innerHTML = renderBenefits();
        return;
      case "challenge":
        refs.panel.innerHTML = renderChallenge();
        return;
      case "bibliography":
