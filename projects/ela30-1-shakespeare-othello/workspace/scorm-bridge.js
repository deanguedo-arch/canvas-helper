...
(function () {
  ...
  const config = {"projectSlug":"ela30-1-shakespeare-othello","version":"2004","storageKeys":["canvas-helper:ela30-1-shakespeare-othello:complete","canvas-helper:ela30-1-shakespeare-othello:character-dossiers","canvas-helper:ela30-1-shakespeare-othello:responses","canvas-helper:ela30-1-shakespeare-othello:worksheet-responses","othello-language-translator-state","othello-close-reading-lab-state","othello-theme-builder-state","canvas-helper:ela30-1-shakespeare-othello:character-dossiers:active","canvas-helper:ela30-1-shakespeare-othello:manual-evidence-notes"],"maxSuspendChars":60000};
