/* Canvas Helper Google Hosted Bridge */
(function () {
  "use strict";

  const config = {"authMode":"google","firebaseConfigCandidates":["./firebase-config.json","./firebase-config.template.json"],"firebaseSdkVersion":"10.12.2","firestoreCollection":"projects","metaKey":"__canvas_helper_google_hosted__forensicstudiesoption2-nextstep-test","progressItems":[],"projectSlug":"forensicstudiesoption2-nextstep-test","schemaVersion":2,"storageKeys":["forensicstudiesoption2-nextstep-test.progress","forensicstudiesoption2-nextstep-test.ui","forensics::module1assignment::v1","forensics::module2assignment::v1","forensics::module3assignment::v1","forensics::module4assignment::v1","forensics::module5assignment::v1","forensics::module6assignment::v1","forensics::module7assignment::v1","forensics::module8assignment::v1"]};
  const sdkSources = ["https://www.gstatic.com/firebasejs/10.12.2/firebase-app-compat.js","https://www.gstatic.com/firebasejs/10.12.2/firebase-auth-compat.js","https://www.gstatic.com/firebasejs/10.12.2/firebase-firestore-compat.js"];
  ...
  function ensureControls() {
    ...
    if (!document.head.querySelector("style[data-canvas-helper-google-hosted]")) {
      ...
      styleTag.textContent = [
        ...
        "body.sidebar-collapsed .canvas-helper-google-hosted-controls--embedded,.app.sidebar-hidden .canvas-helper-google-hosted-controls--embedded,.forensic-layout.menu-collapsed .canvas-helper-google-hosted-controls--embedded,.forensics35-shell.sidebar-compact .canvas-helper-google-hosted-controls--embedded,.menu-collapsed .canvas-helper-google-hosted-controls--embedded,[data-collapsed='true'] .canvas-helper-google-hosted-controls--embedded{display:none!important}",
          "@media (max-width:1023px){body:not(.mobile-nav-open) .sidebar .canvas-helper-google-hosted-controls--embedded,.app:not(.compact-sidebar-open) .sidebar .canvas-helper-google-hosted-controls--embedded,.forensic-layout:not(.mobile-menu-open) .forensic-sidebar .canvas-helper-google-hosted-controls--embedded,.shell-sidebar:not(.visible) .canvas-helper-google-hosted-controls--embedded,aside[data-testid='chapter-menu-panel']:has([data-testid*='mobile-menu-toggle'][aria-expanded='false'])>.canvas-helper-google-hosted-controls--embedded,aside[data-sidebar-responsive-mode='option2-sticky']:has([data-testid*='mobile-menu-toggle'][aria-expanded='false'])>.canvas-helper-google-hosted-controls--embedded{display:none!important}}",
    ...
    controlHost.setAttribute("data-tone", lastStatusTone);
    controlHost.setAttribute("data-authenticated", "false");
  ...
  async function restoreStateForUser(user) {
    ...
    if (!remoteSnapshot.exists) {
      const noRemoteAction = function decideGoogleHostedNoRemoteAction(options){if(!options.hasLocalState){return"ready"}if(options.localMetaUid&&options.localMetaUid!==options.userUid){return"clear-local"}return"persist-local"}({
