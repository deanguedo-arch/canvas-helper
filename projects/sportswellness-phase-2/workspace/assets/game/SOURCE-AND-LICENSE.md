...
Game application derived from uploaded phase2-discipline-game.app.js. Core target/card motion, scoring and thresholds are retained. Input descriptions, state panels, keyboard controls, pause clock, sound and evidence lifecycle are repaired.
