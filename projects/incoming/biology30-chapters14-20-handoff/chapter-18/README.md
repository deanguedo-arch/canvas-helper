# Biology 30 — Chapter 18: Molecular Genetics
...
- `portable/Biology30_Chapter18.html`: derived single-file course; all core assets, fonts and the correct chapter PDF are embedded. Videos require internet, with local written equivalents.
...
12 teaching lessons plus the review; 13 required checks; 30 required selected-response items; 26 written explanations; 24 guided selections; 48 vocabulary terms; 6 labeling activities with 27 targets; 93 original textbook questions/selected supplied-data tasks; 20 reviewed source MC items plus 48 foundation and 12 authored application items. Additional families include flash retrieval, typed responses, ordering and multiple select where appropriate. One optional three-MC/one-written independent transfer set is present. Optional work does not increase required progress.
