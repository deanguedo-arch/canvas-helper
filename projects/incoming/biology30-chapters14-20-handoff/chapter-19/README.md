# Biology 30 — Chapter 19: Genetic Diversity in Populations
...
- `portable/Biology30_Chapter19.html`: derived single-file course; all core assets, fonts and the correct chapter PDF are embedded. Videos require internet, with local written equivalents.
...
9 teaching lessons plus the review; 10 required checks; 24 required selected-response items; 20 written explanations; 18 guided selections; 36 vocabulary terms; 6 labeling activities with 21 targets; 58 original textbook questions/selected supplied-data tasks; 25 reviewed source MC items plus 36 foundation and 9 authored application items. Additional families include flash retrieval, typed responses, ordering and multiple select where appropriate. One optional three-MC/one-written independent transfer set is present. Optional work does not increase required progress.
