...
- Repeated shape tokens: rounded-2xl, rounded-full, rounded-3xl, rounded, rounded-br, rounded-xl, rounded-[2rem, rounded-[1.5rem, rounded-[1.75rem
- Motion and interaction tokens: transition, transition-all, hover:bg-slate-100, hover:bg-slate-600, transition-colors, hover:bg-white, hover:bg-slate-50, active:translate-y-[6px, active:shadow-none
