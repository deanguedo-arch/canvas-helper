# Biology 30 Unit A — CBE system course (2020) — Faithful

- Family: biology30-unit-a-pilot
- Unit boundary: Unit A
- Treatment: faithful
- Status: blocked comparison prototype
- Studio mode: preview and Annotation only; direct editing disabled
- Sources: CBE system course (2020) (0c00ebf519d0a727c569001b3f3840fb04b1040a726fa3d2cb36a9120f005761)

## Build boundary

- Follow projects/resources/biology30-unit-a-pilot/comparison-contract.json.
