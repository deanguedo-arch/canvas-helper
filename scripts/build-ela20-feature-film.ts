...
type LessonSource = {
  ...
  title: string;
  summary: string;
  group: "Module 5 - Feature Film" | "Film Study";
};
...
const LESSON_SOURCES: LessonSource[] = [
  {
    id: "lesson-3-how-to-critically-view-a-film",
    entry: "Module 5/20-1howtoviewafilm.html",
    title: "How to Critically View a Film",
    summary: "Use previewing, genre, audience, and purpose to watch film actively and critically.",
    group: "Module 5 - Feature Film"
  },
  {
