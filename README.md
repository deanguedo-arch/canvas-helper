...
- SCORM 2004 contracts can opt into ungraded action counts/timestamps and active/foreground page-time rows using `actions: {schemaVersion: 1}`. These do not create grades; see [SCORM tracking](docs/workflows/scorm-tracking.md) for recorded actions and the live-report verification boundary.
